...
namespace RpaWinUiComponentsPackage.AdvancedWinUiDataGrid.Models.Row
{
    ...
    internal class RowDataModel : INotifyPropertyChanged
    {
        ...
        /// </summary>
        public ObservableCollection<CellData> Cells { get; set; } = new();
        ...
        /// </summary>
        public CellData? GetCell(string columnName)
        {
        ...
        public void ClearData()
        {
            foreach (var cell in Cells)
            {
                if (cell.ColumnName != "ValidAlerts") // ValidAlerts sa vyčisti osobne
                {
                    cell.Value = null;
                    cell.IsValid = true;
                    // cell.ValidationErrors = string.Empty; // Property doesn't exist in CellData
                }
            }
